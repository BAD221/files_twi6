...
if not hiied:get(bot_id..'twi6:Reply:Mute'..msg.chat_id_) then
if text == 'هلو' then
TextReply = 'ههلو ، 🥳😹💞'
...
hiied:del(bot_id..'twi6:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'ɷ︙تم تفعيل ردود البوت')
return false
end

if text == 'تعطيل ردود البوت' and Owner(msg) then
hiied:set(bot_id..'twi6:Reply:Mute'..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,'ɷ︙تم تعطيل ردود البوت')
return false
end
