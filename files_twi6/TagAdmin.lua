...
hiied:set(bot_id.."twi6:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"ɷ︙تم تفعيل تاك الادمنيه")
end
if text and text == "تعطيل تاك الادمنيه" and Owner(msg) then 
hiied:del(bot_id.."twi6:Tag:Admins:"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "ɷ︙تم تعطيل تاك الادمنيه")
end

if text == 'صيح الادمنيه' or text == "تاك للادمنيه" or text == "وين الادمنيه" then
if hiied:get(bot_id.."twi6:Tag:Admins:"..msg.chat_id_) then 
...
local t = "\nɷ︙المستخدم ~ ["..User_id .."] يصيح الادمنيه \n\n"
k = 0
for i,v in pairs(data.members_) do
if bot_id ~= v.user_id_ then 
k = k + 1
local username = hiied:get(bot_id.."twi6:User:Name"..v.user_id_)
if username then
t = t..""..k.."- ([@"..username.."])\n"
else
t = t..""..k.."- (`"..v.user_id_.."`)\n"
